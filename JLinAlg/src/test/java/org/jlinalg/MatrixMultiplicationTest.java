		...
		extends MatrixMultiplication
{
	...
	{
		MatrixMultiplication.STRASSEN_ORIGINAL_TRUNCATION_POINT = 2;
		assertTrue(m3t3.equals(MatrixMultiplication.strassenOriginal(m3t3,
				identity3)));
		MatrixMultiplication.STRASSEN_ORIGINAL_TRUNCATION_POINT = 48;
	}
	...
	{
		MatrixMultiplication.STRASSEN_WINOGRAD_TRUNCATION_POINT = 2;
		assertTrue(m3t3.equals(MatrixMultiplication.strassenWinograd(m3t3,
				identity3)));
		MatrixMultiplication.STRASSEN_WINOGRAD_TRUNCATION_POINT = 48;
	}
	...
	{
		MatrixMultiplication.STRASSEN_BODRATO_TRUNCATION_POINT = 2;
		assertTrue(m3t3.equals(MatrixMultiplication.strassenBodrato(m3t3,
				identity3)));
		MatrixMultiplication.STRASSEN_BODRATO_TRUNCATION_POINT = 48;
	}
