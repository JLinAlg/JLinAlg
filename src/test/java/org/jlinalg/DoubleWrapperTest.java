...
public class DoubleWrapperTest
{
				...
				DoubleWrapper.FACTORY, 20))
		{
			if (!dw1.equals(DoubleWrapper.FACTORY.zero())) {
				...
				assertTrue(inv.invert().subtract(dw1).abs().le(
						DoubleWrapper.FACTORY.get(0.00001)));
			}
		}
	}
	...
	public final void testAbs()
	{
				...
				DoubleWrapper.FACTORY, 20))
		{
			...
			DoubleWrapper abs = (DoubleWrapper) dw1.abs();
	...
	public void testHashCode()
	{
		...
		DoubleWrapper r3 = DoubleWrapper.FACTORY.get(666.2);
	...
	{
		double a1 = ((DoubleWrapper) a.abs()).doubleValue();
		double b1 = ((DoubleWrapper) b.abs()).doubleValue();
