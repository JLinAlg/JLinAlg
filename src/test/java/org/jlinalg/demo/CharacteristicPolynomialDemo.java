...
public class CharacteristicPolynomialDemo
{
	final static Object[][] s_matrix = {
			{
					"2", Double.valueOf(1.5)
			}, {
					"-1/6", Integer.valueOf(0)
			}
	};
	...
	public static void main(String[] argv)
	{
		...
		LinAlgFactory<Rational> factory = new LinAlgFactory<>(
				Rational.FACTORY);
		...
		// objects.
		Matrix<Rational> a = new Matrix<>(s_matrix, Rational.FACTORY);
		...
		System.out.println("char(a) / min(a): " + characteristicPolynomial
				.euclideanDivision(minimalPolynomial));

		// integrate "char(a)"
		System.out.println(
				"Int(char(a)): " + characteristicPolynomial.integrate());
