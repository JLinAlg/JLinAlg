 ...
 */
public class RationalLinSysSolverTest
{
	...
	public void test1()
	{
		...
		assertTrue(
				LinSysSolver.solutionSpace(a, b) instanceof LinearSubspace<?>);
	...
	public void test2()
	{
		...
		assertEquals(LinSysSolver.solutionSpace(a, b),
				LinSysSolver.solutionSpace(a, b).normalize());
